...
インターネット上で情報を配信・取得する方法はいくつか存在しますが、音声で情報を配信する仕組みは**ポッドキャスト（Podcast）**が有名です。その他に動画を配信するコンテンツはYoutubeなどの動画サービスやラジオを利用する方法が一般的です。多くのエンジニアがPodcastを配信しているので、好きなものを探して視聴して見ると良いでしょう。不定期配信の雑誌が音声購読されている、そんな気分を味わうことができます。
